    ...
    <Fragment>
      <Row style={style.root}>
        ...
        <p style={style.text.text}>
          Privacy Policy<br/>
          Last updated: September 17, 2020<br/>
          <br/>
          ...
          <br/>
          Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to TTglobal, Binh Duong.<br/>
          <br/>
          ...
          <br/>
          Website refers to dd, accessible from [T&T Global](T&T Global)<br/>
          <br/>
          ...
          <br/>
          Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close your web browser. Learn more about cookies: What Are Cookies?.<br/>
